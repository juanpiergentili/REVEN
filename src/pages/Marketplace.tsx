...
const MOCK_VEHICLES: Vehicle[] = [
  {
    ...
    status: 'ACTIVE',
    isFeatured: true,
    photos: ['https://images.unsplash.com/photo-1618341641711-203204969f52?auto=format&fit=crop&q=80&w=800'],
  ...
  },
  {
    ...
    status: 'ACTIVE',
    isFeatured: true,
    photos: ['https://images.unsplash.com/photo-1606577924006-27d39b132ee6?auto=format&fit=crop&q=80&w=800'],
  ...
  },
  {
    ...
    status: 'ACTIVE',
    isFeatured: false,
    photos: ['https://images.unsplash.com/photo-1619767886558-efdc259cde1a?auto=format&fit=crop&q=80&w=800'],
  ...
  },
  {
    ...
    status: 'ACTIVE',
    isFeatured: false,
    photos: ['https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&q=80&w=800'],
