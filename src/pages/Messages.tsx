            ...
            {loading ? (
              ...
              <>
                {isInitializing && !selectedConvo && (
                  <div className="p-4 border-b border-border animate-pulse bg-primary/5">
          ...
          {initError ? (
            <div className="flex-1 flex items-center justify-center p-8">
              <div className="text-center space-y-4 max-w-md">
                ...
                <Button onClick={() => window.location.reload()} variant="outline" className="mt-4 border-red-500/50 text-red-500 hover:bg-red-500/10">REINTENTAR</Button>
              </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <div className="text-center space-y-4">
                <div className="bg-muted p-8 rounded-full inline-block"><MessageCircle className="h-12 w-12 text-muted-foreground opacity-20" /></div>
